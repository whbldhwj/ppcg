      ...
      for (int c1 = 0; c1 <= 1; c1 += 1) {
        {
          ...
          p = isl_printer_start_line(p);
          p = isl_printer_print_str(p, "/* B_IO_L2_in fifo */ hls::stream<int> fifo_B_B_IO_L2_in");
          p = isl_printer_print_str(p, "_");
          p = isl_printer_print_int(p, c0);
          p = isl_printer_print_str(p, "_");
          p = isl_printer_print_int(p, c1);
        ...
        for (int c2 = 0; c2 <= 3; c2 += 1) {
          {
            ...
            p = isl_printer_start_line(p);
            p = isl_printer_print_str(p, "/* C_drain_IO_L1_out fifo */ hls::stream<int> fifo_C_drain_C_drain_IO_L1_out");
            p = isl_printer_print_str(p, "_");
            p = isl_printer_print_int(p, c0);
            p = isl_printer_print_str(p, "_");
            p = isl_printer_print_int(p, c1);
            p = isl_printer_print_str(p, "_");
            p = isl_printer_print_int(p, c2);
            p = isl_printer_print_str(p, ";");
            p = isl_printer_end_line(p);
          }
          if (c2 == 3)
            {
              ...
              p = isl_printer_print_int(p, c1);
              p = isl_printer_print_str(p, "_");
              p = isl_printer_print_int(p, c2 + 1);
              p = isl_printer_print_str(p, ";");
              p = isl_printer_end_line(p);
            }
        }
      ...
      for (int c1 = 0; c1 <= 1; c1 += 1) {
        {
          ...
          p = isl_printer_start_line(p);
          p = isl_printer_print_str(p, "/* C_drain_IO_L2_out fifo */ hls::stream<int> fifo_C_drain_C_drain_IO_L2_out");
          p = isl_printer_print_str(p, "_");
          p = isl_printer_print_int(p, c0);
          p = isl_printer_print_str(p, "_");
          p = isl_printer_print_int(p, c1);
          ...
          if (c2 == 0)
            {
              ...
              p = isl_printer_print_str(p, "fifo_A_PE");
              p = isl_printer_print_str(p, "_");
              p = isl_printer_print_int(p, 2 * c0 + c1);
              p = isl_printer_print_str(p, "_");
