      ...
      for (int c1 = 0; c1 <= 1; c1 += 1) {
        {
          ...
          p = isl_printer_start_line(p);
          p = isl_printer_print_str(p, "/* PE fifo */ channel int fifo_A_PE");
      ...
      for (int c1 = 0; c1 <= 1; c1 += 1) {
        {
          // Print channel declarations of module: PE
          p = isl_printer_start_line(p);
          p = isl_printer_print_str(p, "/* PE fifo */ channel int fifo_B_PE");
          p = isl_printer_print_str(p, "_");
          p = isl_printer_print_int(p, c1);
          p = isl_printer_print_str(p, "_");
          p = isl_printer_print_int(p, c0);
      ...
      for (int c1 = 0; c1 <= 1; c1 += 1)
        {
          // Print channel declarations of module: PE
          p = isl_printer_start_line(p);
          p = isl_printer_print_str(p, "/* PE fifo */ channel int fifo_C_drain_PE");
          p = isl_printer_print_str(p, "_");
          p = isl_printer_print_int(p, c1);
          p = isl_printer_print_str(p, "_");
          p = isl_printer_print_int(p, c0);
    ...
    for (int c0 = 0; c0 <= 1; c0 += 1) {
      {
        ...
        p = isl_printer_start_line(p);
        p = isl_printer_print_str(p, "/* A_L2_in_IO fifo */ channel int fifo_A_A_L2_in_IO");
        p = isl_printer_print_str(p, "_");
        p = isl_printer_print_int(p, c0);
        p = isl_printer_print_str(p, ";");
        p = isl_printer_end_line(p);
    ...
    for (int c0 = 0; c0 <= 1; c0 += 1) {
      {
        ...
        p = isl_printer_start_line(p);
        p = isl_printer_print_str(p, "/* B_L2_in_IO fifo */ channel int fifo_B_B_L2_in_IO");
        p = isl_printer_print_str(p, "_");
        p = isl_printer_print_int(p, c0);
        p = isl_printer_print_str(p, ";");
        p = isl_printer_end_line(p);
      ...
      for (int c1 = 0; c1 <= 1; c1 += 1) {
        {
          ...
          p = isl_printer_start_line(p);
          p = isl_printer_print_str(p, "/* C_drain_L1_out_IO fifo */ channel int fifo_C_drain_C_drain_L1_out_IO");
          p = isl_printer_print_str(p, "_");
          p = isl_printer_print_int(p, c0);
          p = isl_printer_print_str(p, "_");
          p = isl_printer_print_int(p, c1);
    ...
    for (int c0 = 0; c0 <= 1; c0 += 1) {
      {
        ...
        p = isl_printer_start_line(p);
        p = isl_printer_print_str(p, "/* C_drain_L2_out_IO fifo */ channel int fifo_C_drain_C_drain_L2_out_IO");
        p = isl_printer_print_str(p, "_");
        p = isl_printer_print_int(p, c0);
        p = isl_printer_print_str(p, ";");
        p = isl_printer_end_line(p);
