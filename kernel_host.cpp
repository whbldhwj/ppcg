...
int main(int argc, char **argv) {
...

  {
    ...
    std::vector<int, aligned_allocator<int>> dev_A((512) * (512));
    std::vector<int, aligned_allocator<int>> dev_B((512) * (512));
    std::vector<int, aligned_allocator<int>> dev_C((512) * (512));
