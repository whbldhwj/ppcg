...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.kernel0.autotvin_gmem_A.dat"
         "c.kernel0.autotvin_gmem_B.dat"
         "c.kernel0.autotvin_A_V.dat"
         "c.kernel0.autotvin_B_V.dat"
         "c.kernel0.autotvin_C_V.dat"
         "c.kernel0.autotvout_gmem_C.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.kernel0.autotvout_gmem_C.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
