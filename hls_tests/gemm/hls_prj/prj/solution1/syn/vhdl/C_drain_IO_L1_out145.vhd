...
entity C_drain_IO_L1_out145 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of C_drain_IO_L1_out145 is 
    ...
    signal inter_trans_en_0_loa_3_reg_196 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    component C_drain_IO_L1_outlbW IS
    generic (
        DataWidth : INTEGER;
...
begin
    local_C_ping_0_V_U : component C_drain_IO_L1_outlbW
    generic map (
        DataWidth => 64,
        AddressRange => 2,
        AddressWidth => 1)
    ...
    local_C_pong_0_V_U : component C_drain_IO_L1_outlbW
    generic map (
        DataWidth => 64,
        AddressRange => 2,
        AddressWidth => 1)
    ...
    grp_C_drain_IO_L1_out_in_2_fu_120_en_assign_proc : process(inter_trans_en_0_loa_3_reg_196, inter_trans_en_0_loa_reg_209, ap_CS_fsm_state4, arb_1_reg_97, ap_CS_fsm_state5)
    begin
        if ((((arb_1_reg_97 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4)) or ((arb_1_reg_97 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4)))) then 
            grp_C_drain_IO_L1_out_in_2_fu_120_en <= inter_trans_en_0_loa_reg_209(0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
            grp_C_drain_IO_L1_out_in_2_fu_120_en <= inter_trans_en_0_loa_3_reg_196(0);
        else 
