...
reg   [0:0] select_ln480_6_reg_772;
reg   [0:0] select_ln480_6_reg_772_pp1_iter2_reg;
...
wire   [1:0] select_ln446_2_fu_375_p3;
...
wire   [0:0] select_ln480_6_fu_556_p3;
reg   [0:0] select_ln480_6_reg_772_pp1_iter1_reg;
wire   [1:0] select_ln452_fu_582_p3;
wire   [1:0] select_ln479_fu_608_p3;
reg   [1:0] select_ln479_reg_781;
wire   [1:0] select_ln479_2_fu_616_p3;
reg   [1:0] select_ln479_2_reg_786;
wire   [1:0] c7_2_fu_624_p2;
wire   [3:0] select_ln454_fu_636_p3;
wire   [4:0] select_ln452_2_fu_650_p3;
wire  signed [31:0] p_Repl2_5_fu_661_p1;
reg  signed [31:0] p_Repl2_5_reg_807;
reg  signed [31:0] p_Repl2_6_reg_812;
wire  signed [31:0] p_Repl2_s_fu_675_p1;
reg  signed [31:0] p_Repl2_s_reg_817;
reg  signed [31:0] p_Repl2_4_reg_822;
reg   [1:0] local_C_addr_2_reg_827;
reg   [1:0] local_C_addr_2_reg_827_pp1_iter2_reg;
...
wire   [63:0] zext_ln446_2_fu_405_p1;
wire   [63:0] zext_ln479_4_fu_706_p1;
reg    ap_block_pp1_stage0_01001;
wire   [31:0] tmp_3_fu_723_p2;
wire   [0:0] icmp_ln442_fu_361_p2;
wire   [1:0] c6_fu_355_p2;
wire   [1:0] select_ln446_fu_367_p3;
wire   [2:0] tmp_7_fu_387_p3;
...
wire   [0:0] icmp_ln480_4_fu_466_p2;
...
wire   [0:0] and_ln480_8_fu_510_p2;
wire   [0:0] or_ln480_fu_530_p2;
wire   [0:0] select_ln480_4_fu_472_p3;
wire   [0:0] icmp_ln480_5_fu_544_p2;
wire   [0:0] and_ln480_9_fu_550_p2;
wire   [0:0] and_ln480_6_fu_486_p2;
wire   [0:0] xor_ln480_2_fu_564_p2;
wire   [0:0] and_ln480_7_fu_498_p2;
wire   [0:0] or_ln480_2_fu_570_p2;
wire   [1:0] c5_fu_524_p2;
wire   [1:0] select_ln480_5_fu_536_p3;
wire   [0:0] and_ln480_10_fu_576_p2;
wire   [0:0] or_ln479_fu_596_p2;
wire   [0:0] or_ln479_2_fu_602_p2;
wire   [1:0] c6_4_fu_590_p2;
wire   [3:0] add_ln454_2_fu_630_p2;
wire   [4:0] add_ln452_2_fu_644_p2;
wire   [2:0] tmp_8_fu_689_p3;
wire   [3:0] zext_ln479_3_fu_696_p1;
wire   [3:0] zext_ln479_fu_658_p1;
wire   [3:0] add_ln479_3_fu_700_p2;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln449_reg_758 == 1'd0) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        local_C_addr_2_reg_827 <= zext_ln479_4_fu_706_p1;
        p_Repl2_4_reg_822 <= {{fifo_B_in_V_V_dout[63:32]}};
        p_Repl2_5_reg_807 <= p_Repl2_5_fu_661_p1;
        p_Repl2_6_reg_812 <= {{fifo_A_in_V_V_dout[63:32]}};
...
always @ (*) begin
    if (((select_ln480_6_reg_772_pp1_iter2_reg == 1'd1) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter3 == 1'b1))) begin
...
always @ (*) begin
    if (((select_ln480_6_reg_772_pp1_iter2_reg == 1'd1) & (ap_enable_reg_pp1_iter3 == 1'b1) & (1'b0 == ap_block_pp1_stage0_11001))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter2 == 1'b1))) begin
        ...
        local_C_address0 = zext_ln446_2_fu_405_p1;
    end else begin
        local_C_address0 = 'bx;
    end
end
...
assign add_ln452_2_fu_644_p2 = (indvar_flatten20_reg_276 + 5'd1);

assign add_ln454_2_fu_630_p2 = (indvar_flatten6_reg_298 + 4'd1);

assign add_ln479_3_fu_700_p2 = (zext_ln479_3_fu_696_p1 + zext_ln479_fu_658_p1);

assign add_ln479_fu_719_p2 = (mul_ln479_1_reg_838 + mul_ln479_reg_833);

assign and_ln480_10_fu_576_p2 = (or_ln480_2_fu_570_p2 & and_ln480_7_fu_498_p2);

assign and_ln480_6_fu_486_p2 = (xor_ln480_fu_480_p2 & and_ln480_fu_428_p2);

assign and_ln480_7_fu_498_p2 = (xor_ln480_fu_480_p2 & icmp_ln456_fu_492_p2);

assign and_ln480_8_fu_510_p2 = (xor_ln480_fu_480_p2 & icmp_ln454_fu_504_p2);

assign and_ln480_9_fu_550_p2 = (select_ln480_4_fu_472_p3 & icmp_ln480_5_fu_544_p2);
...
always @ (*) begin
    ap_block_state8_pp1_stage0_iter3 = ((select_ln480_6_reg_772_pp1_iter2_reg == 1'd1) & (fifo_C_drain_out_V_full_n == 1'b0));
end
...
assign c6_4_fu_590_p2 = (2'd1 + select_ln480_5_fu_536_p3);

assign c6_fu_355_p2 = (c6_0_reg_232 + 2'd1);

assign c7_2_fu_624_p2 = (select_ln479_fu_608_p3 + 2'd1);
...
assign fifo_C_drain_out_V_din = tmp_3_fu_723_p2;
...
assign icmp_ln480_4_fu_466_p2 = ((c2_0_reg_265 == 2'd0) ? 1'b1 : 1'b0);

assign icmp_ln480_5_fu_544_p2 = ((select_ln480_fu_458_p3 == 2'd0) ? 1'b1 : 1'b0);

assign icmp_ln480_fu_416_p2 = ((c2_0_reg_265 == 2'd1) ? 1'b1 : 1'b0);

assign mul_ln479_1_fu_715_p2 = ($signed(p_Repl2_6_reg_812) * $signed(p_Repl2_4_reg_822));

assign mul_ln479_fu_711_p2 = ($signed(p_Repl2_5_reg_807) * $signed(p_Repl2_s_reg_817));

assign or_ln479_2_fu_602_p2 = (or_ln479_fu_596_p2 | icmp_ln452_fu_452_p2);

assign or_ln479_fu_596_p2 = (and_ln480_8_fu_510_p2 | and_ln480_10_fu_576_p2);

assign or_ln480_2_fu_570_p2 = (xor_ln480_2_fu_564_p2 | icmp_ln452_fu_452_p2);

assign or_ln480_fu_530_p2 = (icmp_ln452_fu_452_p2 | and_ln480_8_fu_510_p2);

assign p_Repl2_5_fu_661_p1 = fifo_A_in_V_V_dout[31:0];

assign p_Repl2_s_fu_675_p1 = fifo_B_in_V_V_dout[31:0];

assign select_ln446_2_fu_375_p3 = ((icmp_ln442_fu_361_p2[0:0] === 1'b1) ? c6_fu_355_p2 : c6_0_reg_232);
...
assign select_ln452_2_fu_650_p3 = ((icmp_ln452_fu_452_p2[0:0] === 1'b1) ? 5'd1 : add_ln452_2_fu_644_p2);

assign select_ln452_fu_582_p3 = ((and_ln480_8_fu_510_p2[0:0] === 1'b1) ? c5_fu_524_p2 : select_ln480_fu_458_p3);

assign select_ln454_fu_636_p3 = ((or_ln480_fu_530_p2[0:0] === 1'b1) ? 4'd1 : add_ln454_2_fu_630_p2);

assign select_ln479_2_fu_616_p3 = ((and_ln480_10_fu_576_p2[0:0] === 1'b1) ? c6_4_fu_590_p2 : select_ln480_5_fu_536_p3);

assign select_ln479_fu_608_p3 = ((or_ln479_2_fu_602_p2[0:0] === 1'b1) ? 2'd0 : c72_0_reg_320);

assign select_ln480_4_fu_472_p3 = ((icmp_ln452_fu_452_p2[0:0] === 1'b1) ? icmp_ln480_4_fu_466_p2 : icmp_ln480_fu_416_p2);

assign select_ln480_5_fu_536_p3 = ((or_ln480_fu_530_p2[0:0] === 1'b1) ? 2'd0 : ap_phi_mux_c61_0_phi_fu_313_p4);

assign select_ln480_6_fu_556_p3 = ((and_ln480_8_fu_510_p2[0:0] === 1'b1) ? and_ln480_9_fu_550_p2 : and_ln480_6_fu_486_p2);

assign select_ln480_fu_458_p3 = ((icmp_ln452_fu_452_p2[0:0] === 1'b1) ? 2'd0 : c5_0_reg_287);

assign start_out = real_start;

assign tmp_3_fu_723_p2 = (local_C_q0 + add_ln479_fu_719_p2);

assign tmp_7_fu_387_p3 = {{select_ln446_fu_367_p3}, {1'd0}};

assign tmp_8_fu_689_p3 = {{select_ln479_reg_781}, {1'd0}};

assign xor_ln480_2_fu_564_p2 = (icmp_ln454_fu_504_p2 ^ 1'd1);

assign xor_ln480_fu_480_p2 = (icmp_ln452_fu_452_p2 ^ 1'd1);

assign zext_ln442_fu_383_p1 = select_ln446_2_fu_375_p3;

assign zext_ln446_2_fu_405_p1 = add_ln446_fu_399_p2;

assign zext_ln446_fu_395_p1 = tmp_7_fu_387_p3;

assign zext_ln479_3_fu_696_p1 = tmp_8_fu_689_p3;

assign zext_ln479_4_fu_706_p1 = add_ln479_3_fu_700_p2;

assign zext_ln479_fu_658_p1 = select_ln479_2_reg_786;
