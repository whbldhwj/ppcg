...
`define AUTOTB_TVIN_gmem_A  "./c.kernel0.autotvin_gmem_A.dat"
`define AUTOTB_TVIN_gmem_B  "./c.kernel0.autotvin_gmem_B.dat"
`define AUTOTB_TVIN_A_V  "./c.kernel0.autotvin_A_V.dat"
`define AUTOTB_TVIN_B_V  "./c.kernel0.autotvin_B_V.dat"
`define AUTOTB_TVIN_C_V  "./c.kernel0.autotvin_C_V.dat"
`define AUTOTB_TVIN_gmem_A_out_wrapc  "./rtl.kernel0.autotvin_gmem_A.dat"
`define AUTOTB_TVIN_gmem_B_out_wrapc  "./rtl.kernel0.autotvin_gmem_B.dat"
`define AUTOTB_TVIN_A_V_out_wrapc  "./rtl.kernel0.autotvin_A_V.dat"
`define AUTOTB_TVIN_B_V_out_wrapc  "./rtl.kernel0.autotvin_B_V.dat"
`define AUTOTB_TVIN_C_V_out_wrapc  "./rtl.kernel0.autotvin_C_V.dat"
`define AUTOTB_TVOUT_gmem_C  "./c.kernel0.autotvout_gmem_C.dat"
`define AUTOTB_TVOUT_gmem_C_out_wrapc  "./impl_rtl.kernel0.autotvout_gmem_C.dat"
module `AUTOTB_TOP;
